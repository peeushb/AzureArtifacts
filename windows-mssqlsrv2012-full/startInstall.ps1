...
$credential = New-Object System.Management.Automation.PSCredential("$env:COMPUTERNAME\LabAdmin", $secPassword)

$command = $PSScriptRoot + "\SetupMSSQLSrv.ps1"

# Run MS SQL Server install as the artifactInstaller user
